...
Example
-------
python exp06_edgewise_lambda_vector.py \
  ...
  --num_instances 20 \
  --shots 0 \
  --fmt pdf --out outputs/exp06_edgewise_lambda_vector/run01
...
def write_table_tex(path: Path, summary_rows: List[Dict], caption: str, label: str):
    ...
    with path.open("w", encoding="utf-8") as f:
        f.write("% Auto-generated by exp06_edgewise_lambda_vector.py\n")
...
def parse_args():
    ...
    p.add_argument("--out", type=str, default="outputs/exp06_edgewise_lambda_vector")
