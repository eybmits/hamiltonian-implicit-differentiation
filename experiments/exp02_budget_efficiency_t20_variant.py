...
# -*- coding: utf-8 -*-
"""
exp02_budget_efficiency_t20_variant.py (FINAL VERSION: t=20 MARKER VISUALIZATION)
"""
...
def main():
    ...
    p.add_argument("--out", type=str, default="outputs/exp02_budget_efficiency_t20_variant")
